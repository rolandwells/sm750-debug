...
typedef struct _crtc_logicalMode
{
    uint32_t dispCtrl;    /* CRT or PANEL display control channel */

    uint32_t mirrorflag; //0 for clone(of noRandr), 1 for dual, 2 for mirror.
...
}crtc_logicalMode, *crtc_logicalMode_p;

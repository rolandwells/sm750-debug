...
/* below define is useless */
#if 0
#define ALPHA_PLANE_TL_T                                27:27
#define ALPHA_PLANE_TL_T_INSIDE                         1
#define ALPHA_PLANE_TL_T_OUTSIDE                        0
#define ALPHA_PLANE_TL_L                                11:11
#define ALPHA_PLANE_TL_L_INSIDE                         1
#define ALPHA_PLANE_TL_L_OUTSIDE                        0
#endif
...
#else
    #define SECONDARY_DISPLAY_CTRL_RESERVED_2_MASK          25:25
    #define SECONDARY_DISPLAY_CTRL_RESERVED_2_MASK_DISABLE  0
    #define SECONDARY_DISPLAY_CTRL_RESERVED_2_MASK_ENABLE   1
    
    /* The centering feature does not work. */
    #define SECONDARY_DISPLAY_CTRL_CENTERING                24:24
    #define SECONDARY_DISPLAY_CTRL_CENTERING_DISABLE        0
    #define SECONDARY_DISPLAY_CTRL_CENTERING_ENABLE         1
#endif

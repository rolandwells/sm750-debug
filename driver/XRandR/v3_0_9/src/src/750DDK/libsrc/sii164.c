...
* 
*  sii164.c --- SM750 DDK 
*  This file contains the Silicon Image SiI164 chip.
* 
*******************************************************************/
#include <string.h>
#include "defs.h"
...
/****************************************************************
 * Silicon Image SiI 164 property information
 ****************************************************************/
...
#ifdef DDKDEBUG
#include <stdio.h>
void sii164PrintRegisterValues()
{
    ...
    for (regIndex = 0; regIndex < 16; regIndex++)
    {
        ...
        {
            if (regIndex != 0)
                DDKDEBUGPRINT((DISPLAY_LEVEL, "\n"));
        
            DDKDEBUGPRINT((DISPLAY_LEVEL, "%02x: ", regIndex));
        }
        DDKDEBUGPRINT((DISPLAY_LEVEL, "%02x ", i2cReadReg(SII164_I2C_ADDRESS, regIndex)));
    }
    DDKDEBUGPRINT((DISPLAY_LEVEL, "\n"));
}
#endif
...
)
{
    ...
    unsigned char ucDeviceAddress, config;

...
int hw_sm750_map(struct lynx_share* share,struct pci_dev* pdev)
{
	...
	inf_msg("video memory phyAddr = %x, size = %d bytes\n",
...
//		share->accel.de_wait = hw_sm750_deWait;
	...
	int ret= edidReadMonitor(PANEL_PATH, share->edid_data_pnl, 128, 0);
	ret = edidReadMonitorEx(CRT_PATH, share->edid_data_crt, 128, 0, 17, 18);
